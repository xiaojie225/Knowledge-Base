...
Page({
    ...
    analysisTap: function(a) {
        ...
        this.data.analysisUrl ? this.getURLFromString(this.data.analysisUrl) ? (wx.showLoading({
            ...
            wx.hideLoading(), wx.showModal({
                title: "温馨提示",
                content: "检测到你使用的视频无法提取,请检查是不是审核中,或者被你设置了仅限好友观看,或者你使用的链接不是本程序所支持的,请查看教程操作或者更换其他人的视频试一下!也有可能是接口限制提取！",
                confirmText: "确定",
                showCancel: !1,
                confirmColor: "#d4237a"
            });
    ...
    save: function() {
        var t = this;
        var videoUrl = t.data.videoUrl.replace("https", "http")
        ...
        const downloadTask = wx.downloadFile({
            url: 'https://dati.anjiewulian.cn/api/down.php?url=' + url,
            success: function(t) {
